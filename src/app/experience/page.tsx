...
export default function ExperiencePage() {
  return (
    <main className="flex-1 ml-[80px] flex flex-col h-screen">
      <div className="flex-1 mt-[40px] mb-[30px] p-gutter overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
